...
export default function Start() {
  return (
    <div className="px-6 md:px-20 lg:px-40 py-10 bg-gray-950 text-gray-100">
      {/* Title */}
      ...
      <section className="mt-10">
        ...
        <img
          ...
          className="w-full rounded-xl shadow-lg mt-4 mb-8 max-h-[400px] object-contain"
        />
        <p className="leading-relaxed">
          <span className="text-pink-400">
            from langchain.chat_models import ChatOpenAI
          </span>{" "}
          → Imports the LangChain wrapper that knows how to talk to OpenAI chat
          models. <br /> <br />
          <span className="text-pink-400">
          ...
          model. <br /> <br />
          <span className="text-pink-400">def simple_chatbot():</span> → Defines
          the function containing the chat loop. <br /> <br />
          <span className="text-pink-400">
      ...
      <section className="mt-10">
        ...
        <p>
          ...
          <code className="text-pink-400"> AIMessage</code> for cleaner flow and
      ...
      <section className="mt-10">
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            Maintain conversation history using a messages list with both human
            and AI replies.
          </li>
